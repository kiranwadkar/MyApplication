...
public class Commitee_other extends AppCompatActivity {

    String eventurl;
    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;
    List<List_items_commitee_other> listItems;
    RequestQueue requestQueue;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_commitee_other);
        ...
        eventurl = url+"/"+"events"+"/"+year+"/"+branch+"/"+"Other";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                        ...
                        List_items_commitee_other item =new List_items_commitee_other(head,body,price,contact_name,id1,file_name,orig_filename);
                        listItems.add(item);

                    }
                    adapter = new RecyclerViewAdapterCommiteeOther(listItems,getBaseContext());
